...
const performanceItemsWithElements = {
  "التخطيط": ["وضع خطة الدرس اليومي", "تحديد الأهداف التعليمية", "توزيع المنهج"],
  "التنفيذ": ["تطبيق الاستراتيجيات", "إدارة الصف", "استخدام الوسائل"],
  "التقويم": ["تقويم تحصيل الطلاب", "التغذية الراجعة", "تحليل النتائج"],
  "النمو المهني": ["التطوير الذاتي", "المشاركة في البرامج", "الشراكة المجتمعية"],
  "المسؤولية المهنية": ["الالتزام بالأنظمة", "التعاون مع الزملاء", "خدمة المجتمع"],
};
