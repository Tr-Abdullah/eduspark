...
function MOEReportGenerator() {
  ...
  // بنود الأداء الوظيفي مع العناصر - من الصورة
  const performanceItems = {
    "البند الأول: أداء الواجبات الوظيفية": [
      "العنصر الأول: الالتزام بالنظام الرسمي",
      "العنصر الثاني: كتابة التحضير وفق الجدول الدراسي",
      "العنصر الثالث: المشاركة في الإشراف والمناوبة وحصص الانتظار",
      "العنصر الرابع: متابعة الواجبات والدروس والاختبارات",
      "العنصر الخامس: المشاركة في الأنشطة اللاصفية في بيئة العمل",
      "العنصر السادس: المشاركة في برامج النشاط المدرسي"
    ],
    "البند الثاني: التفاعل مع المجتمع المدرسي": [
      "العنصر الأول: المشاركة الفاعلة في مجتمعات التعلم المهنية",
      "العنصر الثاني: الدروس التطبيقية وتبادل الزيارات مع المدرسة (تدريس/كتدرب)",
      "العنصر الثالث: التفاعل في الدورات والورش مع المشرف/مدير/زملاء",
      "العنصر الرابع: بمادج الإنتاج المعرفي في التخصص"
    ],
    "البند الثالث: التفاعل مع الأمور": [
      "العنصر الأول: التواصل الإيجابي مع الأباء الأمور بالتنسيق مع المرشد الطلابي",
      "العنصر الثاني: توظيف وسائل وتطبيقات التقنية الحديثة للطلاب بشكل منتظم",
      "العنصر الثالث: إرسال الخطة الأسبوعية في وقت مبكر",
      "العنصر الرابع: استخدام أنماط اتصالية متنوعة"
    ],
    "البند الرابع: التنوع في أساليب التدريس": [
      "العنصر الأول: استخدام استراتيجيات وطرائق التدريس",
      "العنصر الثاني: يستخدم أساير التوجيهات لتدريس إيداعية وجاذبة للطلاب"
    ],
    "البند الخامس: تحسين نواتج التعلم": [
      "العنصر الأول: تشخيص مستوى إتقان الطلبة في المادة",
      "العنصر الثاني: معالجة الفاقد التعليمي",
      "العنصر الثالث: وضع الخطط العلاجية لطلاب الضعاف",
      "العنصر الرابع: وضع الخطط الإثرائية للطلاب المتميزين",
      "العنصر الخامس: تكريم الطلاب المتميزين والذين تحسن مستواهم"
    ],
    "البند السادس: إعداد وتنفيذ خطة التعلم": [
      "العنصر الأول: اكتمال الواجبات والاختبارات والإجراءات",
      "العنصر الثاني: تنفيذ الدروس وفق الجداول"
    ],
    "البند السابع: توظيف تقنيات ووسائل التعلم المناسبة": [
      "العنصر الأول: التنويع في الوسائل التعليمية",
      "العنصر الثاني: توظيف وسائل وتطبيقات تقنية ومعلوماتية وشبكة الانترنت وصفحات الويب",
      "العنصر الثالث: يفعل التعلم بمصادر التعلم المختلفة في المدرسة"
    ],
    "البند الثامن: تهيئة بيئة تعليمية": [
      "العنصر الأول: يراعي الفروق الفردية وحاجيات الطلاب المختلفة",
      "العنصر الثاني: يحفز الطلاب مادياً ومعنوياً",
      "العنصر الثالث: يفعل أدوات متنوعة في الدرس (سبورة - عالية:لوحية - كتيب - دفتر - ....)"
    ],
    "البند التاسع: الإدارة الصفية": [
      "العنصر الأول: يسمح لو أين بضبط سلوك الطلاب في الحصة",
      "العنصر الثاني: أداء الطلاب في الأنشطة بشكل متعاون أو فردي",
      "العنصر الثالث: يعطي فرص متنوعة تناسب جميع الطلاب",
      "العنصر الرابع: يوائم بين الوقت والنشاط والخطوات الفائزي"
    ],
    "البند العاشر: تحليل نتائج المتعلمين وتحسين مستوياتهم": [
      "العنصر الأول: تحليل نتائج المتعلمين بصفة مستمرة",
      "العنصر الثاني: تصنيف الطلاب وفق تحقيقهم ومتابعة تحسينهم",
      "العنصر الثالث: تقديم تحليل دقيق يقدم تشخيصاً لمواطن القوة والضعف",
      "العنصر الرابع: تنويع أساليب التقويم الورقية والإلكترونية والشفوية"
    ],
    "البند الحادي عشر: تنويع أساليب التقويم": [
      "العنصر الأول: تنفيذ المشروع الفردية والعمام الأدائية",
      "العنصر الثاني: توزيع درجات المقرر وفق الدليل الإجرائي",
      "العنصر الثالث: يفعل ملفات انجاز الطلاب",
      "العنصر الرابع: يلتزم بتعليمات ولوائح الاختبارات والتقويم"
    ]
  };
          ...
          <style jsx global>{`
            @media print {
              ...
              * {
              ...
              /* إصلاح عرض التوقيعات - جنباً إلى جنب */
              .signatures-grid {
                display: grid !important;
                grid-template-columns: repeat(2, 1fr) !important;
                gap: 1rem !important;
